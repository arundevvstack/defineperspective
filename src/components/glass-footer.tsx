          ...
          <div className="col-span-1 flex flex-col items-start text-left">
             <h4 className="text-[10px] font-black text-white uppercase tracking-widest mb-6 text-primary-accent">Resources</h4>
               <ul className="flex flex-col items-start gap-4 text-sm text-zinc-400 font-light">
                  <li><Link href="/ai-content-creation-video-production-course-india" className="hover:text-primary-accent transition uppercase tracking-widest text-[10px] font-bold text-white">Academy Course</Link></li>
                  <li><Link href="/knowledge-center" className="hover:text-primary-accent transition uppercase tracking-widest text-[10px]">Knowledge Center</Link></li>
                  <li><Link href="/analysis" className="hover:text-primary-accent transition uppercase tracking-widest text-[10px]">Security Console</Link></li>
