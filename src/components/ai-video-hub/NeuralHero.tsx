    ...
    <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-16 px-6 overflow-hidden bg-obsidian">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="label-mono !text-zinc-400 group-hover:!text-white transition-colors">
              India's Leading <span className="text-primary-accent">AI Video Production Studio_</span>
            </span>
          </motion.div>
          ...
          <div className="space-y-6 mb-16 max-w-7xl">
            ...
            >
              Professional <br />
              <span className="text-primary-accent">AI Video_</span> <br />
              Services in India
            </motion.h1>
            ...
            >
              DP AI Studio is a cinematic AI video production company in Kerala creating AI TV commercials, AI ad films, AI product campaigns, and cinematic branded content for businesses across India, including Bangalore, Chennai, Mumbai, and Hyderabad.
            </motion.p>
          </div>
          ...
          >
            {[
              "AI Commercial Experts",
              "Cinematic Production",
              "Viral Brand Campaigns",
              "Luxury Ad Films",
              "Vertical Reel Systems",
              "72H Fast Pipeline"
            ].map((text) => (
      ...
      <div className="absolute inset-0 z-[-1] opacity-30 pointer-events-none">
         <Image 
           ...
           alt="Neural Cinematic Background" 
           fill 
           unoptimized
