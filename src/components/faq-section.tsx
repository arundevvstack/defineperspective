      ...
      <div className="container mx-auto relative z-10 max-w-7xl">
        ...
        <div className="mb-20 md:mb-32 flex flex-col lg:flex-row lg:items-end justify-between gap-10 md:gap-16">
           ...
           >
              ...
              >
                 <Search className="text-zinc-600 group-hover:text-primary-accent transition-colors shrink-0" size={24} />
                 <span className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 group-hover:text-white transition-colors">Search for answers</span>
              </button>
           </motion.div>
        </div>
            ...
            return (
              ...
              >
                <button 
                  ...
                  className="w-full p-8 md:p-14 flex items-center justify-between text-left gap-6 md:gap-10"
                ...
                >
                   ...
                   <div className={cn(
                     ...
                     isOpen 
                      ...
                      {isOpen ? <Minus size={20} strokeWidth={3} className="md:w-8 md:h-8" /> : <Plus size={20} strokeWidth={3} className="md:w-8 md:h-8" />}
                   </div>
                </button>
        ...
        <div className="mt-24 md:mt-32 pt-20 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-12">
           <div className="flex items-center gap-6">
              <div className="h-14 w-14 md:h-16 md:w-16 rounded-2xl bg-primary-accent/10 border border-primary-accent/20 flex items-center justify-center">
                 <HelpCircle className="text-primary-accent" size={24} />
              </div>
              <div>
                 <h4 className="text-lg md:text-xl font-bold text-white uppercase tracking-tighter">Still have questions?</h4>
                 <p className="text-[10px] md:text-sm text-zinc-500 uppercase tracking-widest font-mono mt-1">Our production team is ready to assist.</p>
              </div>
           </div>
