...
export default function HomeContent() {
  ...
  return (
    <main className="min-h-screen bg-obsidian text-white transition-colors duration-500 overflow-x-hidden relative selection:bg-primary-accent selection:text-white theme-blue">
      ...
      {/* 🎬 SHOWREEL BANNER — BLOCK 2 */}
      <section className="relative bg-black border-b border-white/5 overflow-hidden">
        {/* Ambient glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(235,30,44,0.07)_0%,transparent_70%)] pointer-events-none z-0" />

        <div className="container-max relative z-10 py-24 md:py-40 px-6 md:px-12">
          {/* Section header */}
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 mb-16">
            <div className="space-y-4">
              <span className="label-mono !text-primary-accent">DP AI Studio — Official Showreel</span>
              <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter text-white leading-none">
                Watch What <br />
                <span className="text-primary-accent">We Build_</span>
              </h2>
            </div>
            <p className="body-copy max-w-sm text-right opacity-40 uppercase tracking-widest text-[10px]">
              India's most advanced neural production pipeline. Every frame engineered for impact.
            </p>
          </div>

          {/* Showreel embed frame */}
          <div
            className="relative w-full aspect-video rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[0_0_120px_-30px_rgba(235,30,44,0.25)] group cursor-pointer bg-black"
            onClick={() => setActiveVideo("UHQ-zx_RDUY")}
          >
            {/* YouTube thumbnail as poster */}
            <img
              src="https://img.youtube.com/vi/UHQ-zx_RDUY/maxresdefault.jpg"
              alt="DP AI Studio Showreel — AI Video Production India"
              className="w-full h-full object-cover opacity-60 group-hover:opacity-80 group-hover:scale-[1.02] transition-all duration-[2500ms]"
            />
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <motion.div
                ...
                className="h-24 w-24 md:h-32 md:w-32 rounded-full bg-primary-accent/10 backdrop-blur-3xl border-2 border-primary-accent/60 text-primary-accent flex items-center justify-center group-hover:bg-primary-accent group-hover:text-black transition-colors duration-500 shadow-2xl shadow-primary-accent/30"
              >
            ...
            <div className="absolute bottom-0 inset-x-0 p-8 md:p-12 flex items-end justify-between">
              <div>
                <span className="block text-[9px] font-mono text-zinc-500 uppercase tracking-[0.4em] mb-2">Now Streaming</span>
                <h3 className="text-xl md:text-3xl font-black uppercase text-white tracking-tighter">DP AI Studio — 2025 Showreel</h3>
              </div>
              <div className="hidden md:flex items-center gap-6">
                {["4K MASTER", "NEURAL GRADE", "CINEMATIC AI"].map(tag => (
                  <span key={tag} className="px-4 py-2 rounded-full border border-white/10 bg-black/50 backdrop-blur-md text-[9px] font-mono text-zinc-400 uppercase tracking-widest">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          {/* CTA strip */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-8 mt-12 pt-10 border-t border-white/5">
            <div className="flex items-center gap-6">
              <div className="h-2 w-2 rounded-full bg-primary-accent animate-pulse" />
              <span className="label-mono !text-zinc-500">India's #1 AI-Powered Commercial Studio</span>
            </div>
            <div className="flex gap-4">
              ...
              >
                <span className="label-mono !text-xs">View Full Channel</span>
                <ArrowRight size={16} />
              </a>
              <Link href="/contact" className="btn-primary !h-14 !px-8 text-xs">
