      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.8] text-white">
            Real Estate <br />{" "}
            <span className="text-primary-accent italic font-black">Builders_</span>
          </h1>
          ...
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best real estate video production in India?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed font-light uppercase tracking-tighter">
                Define Perspective is a leader in high-end property films. We
                provide specialized video solutions for builders and developers
                in Kerala and across India, focusing on cinematic walkthroughs
                and high-conversion social ads.
              </p>
            </div>
          </div>
        </div>
