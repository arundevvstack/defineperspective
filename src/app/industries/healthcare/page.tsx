      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.8] text-white">
            {" "}
            Healthcare <br />{" "}
            <span className="text-primary-accent italic">Trust_Hub_</span>{" "}
          </h1>{" "}
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best hospital video production in Kerala?
              </h4>{" "}
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is a leader in trust-centric hospital
                marketing. We provide specialized video solutions for clinics
                and multi-specialty hospitals in Kerala and across India,
                focusing on patient experience, medical heritage, and
                educational content.
              </p>{" "}
            </div>{" "}
          </div>{" "}
