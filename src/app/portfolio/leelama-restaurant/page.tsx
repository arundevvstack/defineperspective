...
export default function LeelamaRestaurantAICaseStudy() {
  return (
    <main className="min-h-screen bg-obsidian text-white pt-40 pb-40 px-6 md:px-12 relative overflow-hidden theme-blue">
      ...
      <div className="container mx-auto max-w-6xl relative z-10 text-center">
        ...
        <section className="mb-40">
           <div className="relative aspect-[9/16] max-w-md mx-auto rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl">
              <LiteYouTube videoId="doApkqt7zDU" title="Leelama Restaurant AI Ad" aspectRatio="vertical" priority />
           </div>
        </section>
