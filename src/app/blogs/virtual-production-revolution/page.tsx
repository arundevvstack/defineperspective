    ...
    <main className="min-h-screen bg-obsidian text-white pt-32 pb-40 relative overflow-hidden font-sans">
      ...
      <section className="container mx-auto px-6 md:px-12 mb-24 lg:mb-40">
        <div className="max-w-5xl">
          ...
          >
             <span className="text-[10px] font-mono tracking-[0.5em] uppercase text-primary-accent mb-8 block font-black underline">Technical Archive {" // "} Production Node</span>
      ...
      <article className="container mx-auto px-6 md:px-12 max-w-4xl">
        ...
        <section className="border-t border-white/10 pt-32 mb-32">
           <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-20 text-center text-primary-accent italic">
