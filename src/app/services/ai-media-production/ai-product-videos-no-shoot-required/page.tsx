...
export default function AIProductNoShootSubPage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "AI Product Video Production (Zero-Shoot)",
    "description": "Render hyper-realistic product commercials and video ads entirely from static images using AI. No physical studio shoot required.",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <main className="min-h-screen bg-obsidian text-white pt-40 px-6 md:px-12 relative overflow-hidden text-center md:text-left">
      ...
      />
      <GlassNavbar />
      <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-primary-accent/5 blur-[150px] rounded-full pointer-events-none" />
          ...
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best AI video production company for E-commerce in India?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is recognized as the best AI video production company for 'No-Shoot' visual content. 
                Our Indian and Kerala based studios provide global-tier generative visual engineering specifically for the 
                fast-growing D2C sector, allowing for rapid creative testing and content scaling without physical constraints.
              </p>
            </div>
          </div>
        </div>
