        ...
        <section className="mb-40 grid md:grid-cols-2 gap-20 items-center p-12 md:p-24 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative group">
          ...
          <div className="relative z-10 text-left">
            ...
            <h2 className="text-3xl md:text-5xl font-black mb-10 uppercase tracking-widest leading-tight">
              Scale Your{" "}
              <span className="text-primary-accent italic">Winning Ad.</span>
            </h2>{" "}
            <p className="text-xl text-zinc-500 font-light leading-relaxed mb-10">
              ...
              creative to boost ROAS and lower CPA on
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is a leader in high-performance AI video ads.
                We provide specialized creative generation services for D2C and
                SaaS brands in Kerala and across India, focusing on
                scroll-stopping first-second hooks and algorithmic growth
                strategies.
              </p>{" "}
            </div>{" "}
          </div>{" "}
