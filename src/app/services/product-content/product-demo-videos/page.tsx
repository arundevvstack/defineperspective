          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight">
                Best product demo video company in India?
              </h4>{" "}
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is a leader in technical and product
                storytelling. We provide specialized demo video production for
                Indian tech startups and established global hardware brands,
                focusing on clarity, visual excellence, and measurable
                conversion growth.
              </p>{" "}
            </div>{" "}
          </div>{" "}
