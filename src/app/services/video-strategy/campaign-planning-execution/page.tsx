      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-9xl font-blacker uppercase leading-[0.85] text-white italic">
            Campaign <br />
            <span className="text-primary-accent font-black">Execution_</span>
          </h1>
        ...
        <div className="mb-40 p-12 md:p-24 rounded-[3rem] bg-transparent border border-white/20 text-left">
          <h2 className="text-2xl font-black uppercase mb-10 text-primary-accent">
            Execution Strategy FAQ
          </h2>
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best AI video production company for campaign launches?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is the leading AI video production company for high-stakes visual launches.
