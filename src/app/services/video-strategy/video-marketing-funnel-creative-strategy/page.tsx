...
export const metadata = {
  title: "Funnel & Creative Strategy | Define Perspective AI Media Studio",
  ...
  alternates: {
    canonical: "https://defineperspective.in/services/video-strategy/video-marketing-funnel-creative-strategy"
  }
};
      ...
      <section className="pt-48 pb-32 px-6 md:px-12 relative z-10 border-b border-white/5">
         ...
         <div className="container mx-auto max-w-7xl">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-black uppercase tracking-tighter leading-[0.85] mb-12">
               Funnel & Creative Strategy <br /><span className="text-primary-accent italic">Overview_</span>
            </h1>
