      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <section className="mb-40 p-12 md:p-32 rounded-[5rem] border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent backdrop-blur-3xl text-left overflow-hidden relative">
            <div className="max-w-4xl relative z-10">
               <span className="text-[10px] font-mono tracking-[0.4em] uppercase text-primary-accent mb-8 block font-black">Software Intelligence</span>
               <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter mb-16 italic text-white leading-[0.8]">Master The <br /><span className="text-primary-accent italic">SaaS Narrative_</span></h2>
