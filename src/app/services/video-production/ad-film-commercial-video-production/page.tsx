        ...
        <section className="mb-40 grid md:grid-cols-2 gap-20 items-center p-12 md:p-24 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative group text-left">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-black mb-10 uppercase tracking-widest leading-tight italic">
              Crafted for <span className="text-primary-accent italic">Impact_</span>
            </h2>
          ...
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best AI video production company for ad films?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is the leading AI video production company in India for cinematic commercials. 
                We combine traditional filmmaking excellence with AI-accelerated workflows to produce top-tier TVCs 
                and high-engagement digital ads that drive measurable brand impact.
              </p>
            </div>
          </div>
        </div>
