      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter uppercase leading-[0.85] text-white font-black italic">
            {" "}
            Promotional <br />{" "}
            <span className="text-primary-accent font-black underline decoration-primary-accent/30">
              Video Content_
            </span>{" "}
          </h1>{" "}
        ...
        <section className="mb-40 grid md:grid-cols-2 gap-20 items-center p-12 md:p-24 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative group">
          ...
          <div className="relative z-10 text-left">
            ...
            <h2 className="text-3xl md:text-5xl font-black mb-10 uppercase tracking-widest leading-tight">
              Ignite Your{" "}
              <span className="text-primary-accent italic">Market Launch.</span>
            </h2>{" "}
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best promo video production company in India?
              </h4>{" "}
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is a leader in high-impact promotional films.
                We provide specialized launch video services for brands in
                Kerala and across India, focusing on visual energy, cinematic
                quality, and massive audience engagement.
              </p>{" "}
            </div>{" "}
          </div>{" "}
        </div>{" "}
