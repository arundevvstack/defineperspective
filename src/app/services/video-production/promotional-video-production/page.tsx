...
export const metadata: Metadata = {
  ...
  keywords: [
    "promotional video production India",
    "best promo video agency Kerala",
    "product launch videos Kochi",
    "creative promo films India",
  ],
};
export default function PromoVideoSubPage() {
  const jsonLd = {
    ...
    "description": "High-energy promotional video production for brands in India. Product launches and marketing campaigns engineered for growth.",
    "provider": {
      "@type": "Organization",
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-9xl font-blacker uppercase leading-[0.85] text-white italic">
            Promotional <br />
            <span className="text-primary-accent font-black underline decoration-primary-accent/30">Video Content_</span>
          </h1>
          <p className="text-xl md:text-3xl text-zinc-400 font-light max-w-4xl leading-relaxed mx-auto md:mx-0 uppercase tracking-widest leading-loose">
            "Energy is the new strategy. We build high-impact promo films to
            launch products and ignite growth across India."
          </p>
        </header>
        ...
        <section className="mb-40 grid md:grid-cols-2 gap-20 items-center p-12 md:p-24 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative group text-left shadow-2xl">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-black mb-10 uppercase leading-tight italic">
              Ignite Your <span className="text-primary-accent italic">Market Launch.</span>
            </h2>
            <p className="text-xl text-zinc-500 font-light leading-relaxed mb-10">
              Most promotional videos are forgettable. We specialize in
              fast-paced, cinematic, and high-energy promo films that capture
              attention in the first second. Our Indian and Kerala based
              production teams utilize high-spec camera kits and next-gen
              editing to ensure that your product launch stands out in the
              competitive Indian marketplace.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                href="/contact?subject=Promo Video Project enquiry"
        ...
        <div className="mb-40 p-12 md:p-24 rounded-[3rem] bg-white/5 border border-white/20 text-left">
          <h2 className="text-2xl font-black uppercase mb-10 text-primary-accent font-black">
            Promo Visibility FAQ
          </h2>
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best AI video production company for Promo Videos?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is uniquely recognized as the best AI video production company for high-impact promotional films in India. 
                We combine fast-paced cinematic production with AI-driven visual hooks to ensure brands across Kerala and major 
                Indian metros launch products with maximum audience engagement and visual energy.
              </p>
            </div>
          </div>
        </div>
