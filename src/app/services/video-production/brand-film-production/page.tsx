...
export default function BrandFilmSubPage() {
  const jsonLd = {
    ...
    "description": "Elite brand film production and cinematic storytelling for visionary companies in India. Visual legacies engineered for growth.",
    "provider": {
      "@type": "Organization",
  ...
  return (
    <main className="min-h-screen bg-obsidian text-white pt-40 px-6 md:px-12 relative overflow-hidden text-center md:text-left">
      ...
      />
      <GlassNavbar />
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-accent/5 blur-[180px] rounded-full pointer-events-none" />
      <div className="container mx-auto max-w-6xl relative z-10">
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-[10rem] font-blacker uppercase leading-[0.8] text-white italic">
            Brand <br />
            <span className="text-primary-accent font-black">Storytelling_</span>
          </h1>
        ...
        <section className="mb-40 grid md:grid-cols-2 gap-20 items-center p-12 md:p-24 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative group text-left shadow-2xl">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                href="/contact?subject=Brand Film Project enquiry"
          ...
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic">
                Best AI video production company for Brand Films?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is recognized as the best AI video production company for cinematic brand storytelling in India. 
                Our neural-enhanced filmmaking pipeline allows us to craft visual legacies for high-growth companies across Kerala and 
                India, focusing on global-tier narrative depth and cinematic excellence.
              </p>
            </div>
          </div>
        </div>
