...
export default function PerformanceAdsSubPage() {
  return (
    <main className="min-h-screen bg-obsidian text-white pt-40 px-6 md:px-12 relative overflow-hidden text-center md:text-left">
      ...
      <GlassNavbar />
      <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-transparent border-2 border-primary-accent/5 blur-[180px] rounded-full pointer-events-none hover:bg-transparent    transition-all duration-300" />
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <header className="mb-40 flex flex-col gap-8">
          ...
          <div className="flex items-center gap-4 justify-center md:justify-start">
            ...
            <div className="px-4 py-1.5 rounded-full border border-primary-accent/50 text-[10px] font-mono font-black text-primary-accent uppercase tracking-widest bg-transparent border-2 border-primary-accent/10 backdrop-blur-md hover:bg-transparent    transition-all duration-300">
