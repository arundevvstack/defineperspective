...
export const metadata = {
  title: "Video Ads (Meta/YT/Google) | Define Perspective AI Media Studio",
  ...
  alternates: {
    canonical: "https://defineperspective.in/services/performance-video/video-ads-meta-yt-google-production"
  }
};
      ...
      <section className="pt-48 pb-32 px-6 md:px-12 relative z-10 border-b border-white/5">
         ...
         <div className="container mx-auto max-w-7xl">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-black uppercase tracking-tighter leading-[0.85] mb-12">
               Video Ads (Meta/YT/Google) <br /><span className="text-primary-accent italic">Overview_</span>
            </h1>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                 ...
                 <p className="text-zinc-400 leading-relaxed font-light text-lg mb-8 uppercase tracking-widest">
                   Define Perspective provides premier Video Ads (Meta/YT/Google) services. As the top AI video production company in Kerala, we fuse cutting-edge neural algorithms with cinematic artistry to deliver unparalleled visual content for brands across India and global markets.
                 </p>
