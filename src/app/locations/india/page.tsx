...
export const metadata: Metadata = {
  title:
    "Best Video Production Company India | Top Media Agency Pan-India | Define Perspective",
  description:
    "India's leading AI-first video production agency. Helping brands across Mumbai, Bangalore, Delhi, and beyond dominate with cinematic brand films and performance ads.",
  keywords: [
    "video production company India",
    "best media agency Bangalore",
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <header className="mb-40 flex flex-col gap-8">
          ...
          <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.8] text-white">
            India's <br />{" "}
            <span className="text-primary-accent italic">Media_Leader_</span>
          </h1>
          <p className="text-xl md:text-3xl text-zinc-400 font-light max-w-4xl leading-relaxed mx-auto md:mx-0">
            "From local heritage to global excellence. We build the visual
            infrastructure for India's most ambitious national brands."
          </p>
        </header>
        ...
        <section className="mb-40 grid md:grid-cols-2 gap-20 items-center p-12 md:p-24 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative group">
          <div className="relative z-10 text-left">
            <h2 className="text-3xl md:text-5xl font-black mb-10 uppercase tracking-widest leading-tight italic">
              National{" "}
              <span className="text-primary-accent italic font-black">Velocity_</span>
            </h2>
            <p className="text-xl text-zinc-500 font-light leading-relaxed mb-10">
              Define Perspective serves as a high-fidelity creative hub for
              brands across India. Our decentralized production model allows us
              to execute 8K cinematic films and high-velocity ad campaigns for
              clients in Mumbai, Bangalore, Delhi, and Hyderabad, all managed
              from our elite strategic core.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                href="/contact?location=India"
              ...
              <Link
                href="https://wa.me/919496191684?text=Hi%20Define%20Perspective,%20I'm%20interested%20in%20National Project."
                target="_blank"
          ...
          <div className="relative aspect-video rounded-3xl overflow-hidden border border-white/10 group shadow-xl grayscale hover:grayscale-0 transition-all duration-700 hover:text-primary-accent transition-all duration-300">
            <Image
              src="https://images.unsplash.com/photo-1524492412937-b28074a5d7da?q=80&w=2071&auto=format&fit=crop"
              alt="Pan-India Brand Perspective"
              fill
        ...
        <div className="mb-40 p-12 md:p-24 rounded-[3rem] bg-transparent border border-white/20 text-left">
          <h2 className="text-2xl font-black uppercase tracking-widest mb-10 text-primary-accent font-black">
            National Visibility FAQ
          </h2>
          <div className="space-y-12">
            <div>
              <h4 className="text-xl font-bold text-white mb-4 uppercase tracking-tight italic font-black font-black italic">
                Leading video production agency in India?
              </h4>
              <p className="text-zinc-400 font-light leading-relaxed font-light uppercase tracking-tighter italic">
                ...
                top-tier Indian brands, focusing on cinematic quality and
                national market resonance.
              </p>
            </div>
          </div>
        </div>
