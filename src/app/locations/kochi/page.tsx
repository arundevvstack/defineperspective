...
export default function KochiLocationPage() {
  const jsonLd = {
    ...
    "description": "Kochi's premier AI-powered video production and ad agency. Helping Cochin's high-stakes brands and builders dominate with cinematic brand films.",
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-zinc-400 font-light leading-relaxed">
                Define Perspective is the leading AI video production company in Kochi. We
                ...
                market impact through neural-powered workflows.
              </p>
            </div>
          </div>
        </div>
