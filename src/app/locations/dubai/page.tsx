...
export const metadata: Metadata = {
  title: "AI Video Production Company in Dubai | DP AI Studio",
  description: "The leading AI video production agency serving Dubai and the UAE. We create cinematic commercials for enterprise brands across the Middle East.",
};
...
export default function DubaiLocationPage() {
  const schema = {
    ...
    "@type": "ServiceArea",
    "name": "Dubai, UAE",
    "description": "AI video production and generative commercial services for the UAE market."
  };
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <header className="mb-32 text-center flex flex-col items-center">
          ...
          <h1 className="text-5xl md:text-8xl font-blacker uppercase leading-[0.8] tracking-tighter mb-12 italic">
            Dubai <br />
            <span className="text-primary-accent">UAE_</span>
          </h1>
          <p className="text-xl md:text-2xl text-zinc-300 max-w-3xl font-light uppercase tracking-widest leading-relaxed">
            Powering the Middle East's most innovative brands with high-fidelity, Arabic-localized neural commercial production.
          </p>
        </header>
