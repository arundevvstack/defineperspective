...
export default function AIStudiosPage() {
  ...
  return (
    <main className="min-h-screen bg-obsidian text-white pt-40 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-transparent border-2 border-primary-accent/10 blur-[200px] rounded-full pointer-events-none hover:bg-transparent    transition-all duration-300" />
      <div className="absolute bottom-1/4 left-0 w-[500px] h-[500px] bg-transparent border-2 border-primary-accent/10 blur-[180px] rounded-full pointer-events-none hover:bg-transparent    transition-all duration-300" />
      <div className="container mx-auto max-w-6xl relative z-10">
        
        <header className="mb-40 text-center flex flex-col items-center">
          
          <div className="h-16 w-16 rounded-2xl bg-transparent border-2 border-primary-accent flex items-center justify-center text-primary-accent-fg mb-12 shadow-xl hover:bg-transparent    transition-all duration-300">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-40">
          ...
          {[
            ...
            <Link
              key={pillar.title}
              href={pillar.href}
              className="group cursor-pointer relative p-12 rounded-[4rem] border border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden/30 transition-all transition-shadow hover:shadow-[0_0_50px_rgba(var(--accent-rgb),0.15)]  transition-all duration-300"
            >
        ...
        <section className="mb-40 grid lg:grid-cols-2 gap-20 items-center">
            ...
            <ul className="space-y-10">
              ...
              {[
                ...
                <li key={item.t} className="flex gap-8 group">
                  ...
                  <div className="h-4 w-4 rounded-full bg-transparent border-2 border-primary-accent/40 flex items-center justify-center shrink-0 mt-2 hover:bg-transparent    transition-all duration-300">
                    
                    <div className="h-1.5 w-1.5 rounded-full bg-transparent border-2 border-primary-accent hover:bg-transparent    transition-all duration-300" />
                  </div>
                  <div>
          ...
          <div className="relative aspect-square rounded-[4rem] overflow-hidden border border-white/5 shadow-xl">
            ...
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-transparent border-2 border-primary-accent/10 hover:bg-transparent    transition-all duration-300" />
          </div>
        </section>
        {/* High-Conversion CTA */}
        <div className="py-40 text-center border-t border-white/5 mt-40">
          ...
          <Link
            ...
            className="h-24 px-20 rounded-full bg-transparent border-2 border-primary-accent text-zinc-100 font-black uppercase tracking-widest text-lg hover:scale-110 active:scale-95 transition-all shadow-xl hover:bg-transparent    transition-all duration-300"
          >
