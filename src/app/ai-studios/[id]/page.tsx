...
const projects = {
  "ai-design-1": {
    ...
    description: "Developing the first AI-generated virtual model for an Indian luxury brand. Every texture, lighting angle, and pose was meticulously engineered through multi-stage neural diffusion.",
    gallery: [
...
export default function AICaseStudy({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  return (
    <main className="min-h-screen bg-obsidian text-white relative theme-blue">
      ...
      {/* 1. Full-Bleed Hero Image (Neural Theme) */}
      ...
      <div className="container mx-auto px-6 md:px-24 py-40">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 mb-48">
            <div className="lg:col-span-12">
               <h2 className="text-xs font-mono tracking-[0.5em] uppercase text-zinc-600 mb-12 border-b border-white/5 pb-4">Neural Architecture Context</h2>
            </div>
            ...
            <div className="lg:col-span-4 lg:col-start-9 space-y-12">
               {project.technical.map(t => (
                 <div key={t.id} className="flex items-center gap-6 p-8 rounded-3xl bg-white/5 border border-white/5 group hover:bg-primary-accent/10 hover:border-primary-accent/30 transition-all border-l-[3px] border-l-primary-accent">
                    ...
                    <div>
                       <span className="text-[10px] font-mono text-primary-accent/60 uppercase block mb-1 font-bold">{t.label}</span>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-48">
             <div className="md:col-span-2 aspect-[21/9] rounded-[3rem] overflow-hidden group relative border border-white/5">
                <img src={project.gallery[0]} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" alt="Detail 1" />
             ...
             <div className="aspect-[4/5] rounded-[3rem] overflow-hidden group border border-white/5">
                <img src={project.gallery[1]} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" alt="Detail 2" />
             </div>
             <div className="aspect-[4/5] rounded-[3rem] overflow-hidden group border border-white/5">
                <img src={project.gallery[2]} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" alt="Detail 3" />
             </div>
             <div className="md:col-span-2 aspect-video rounded-[3rem] overflow-hidden group border border-white/5">
                <img src={project.gallery[3]} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" alt="Detail 4" />
             </div>
         </div>
         ...
         <section className="p-16 md:p-32 rounded-[4rem] border border-primary-accent/20 bg-gradient-to-br from-white/5 to-primary-accent/5 text-center relative overflow-hidden group">
           ...
           <div className="relative z-10">
             <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tight text-white mb-12 leading-[0.9]">
               Deploy the <br /><span className="text-primary-accent drop-shadow-[0_0_20px_var(--glow)]">Future of Design.</span>
             </h2>
             <p className="text-2xl text-zinc-500 font-light max-w-2xl mx-auto mb-20 leading-relaxed">
               Collaborate with DP AI Studios to initialize your brand's synthetic evolution.
             </p>
             <div className="flex flex-wrap justify-center gap-8">
               <button 
                 onClick={() => window.location.href = '/contact?subject=AI Studio Intake: General Inquire'}
               ...
               <button 
                 onClick={() => window.location.href = '/portfolio?view=ai'}
